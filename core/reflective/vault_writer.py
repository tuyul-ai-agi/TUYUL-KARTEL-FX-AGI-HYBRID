...
if __name__ == "__main__":
    ...
    sample_entry = {
        ...
        "timeframe": "H4",
        "bias": "Bullish",
        "Fusion_Confidence": 0.928,
        "WLWCI": 0.911,
        "RCAdj": 0.79,
        "IntegrityIndex": 0.92,
        "Pattern": "impulsive",
        "source": "fusion_reflex_roll",
        "comment": "Automated reflective sync via MCP",
    }

    writer.write_entry(sample_entry)
    print("📊 Vault Summary:", writer.summarize_vault())
