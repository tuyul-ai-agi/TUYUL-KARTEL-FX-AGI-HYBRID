...
if __name__ == "__main__":
    ...
    sample_entry = {
        ...
        "timeframe": "H4",
        "bias": "Bullish",
        "Fusion_Confidence": 0.933,
        "WLWCI": 0.914,
        "RCAdj": 0.82,
        "IntegrityIndex": 0.91,
        "Pattern": "impulsive",
    }
    vw.write_entry(sample_entry)

    print("\n📊 Current Vault Summary:")
    print(vw.summarize_vault())

    # Jalankan rebalancing loop (12 jam → 30s demo mode)
    try:
        vw.auto_integrity_rebalance(interval_hours=0.0083)  # 30 detik untuk demo
    except KeyboardInterrupt:
        print("\n🛑 Rebalance dihentikan manual oleh user.")
